...
class ObjaverseMASt3RDataset(Dataset):
    ...
    def __getitem__(self, idx):
        try:
            ...
            rgb_mast3r = load_images([res1['rgb_path_1'], res2['rgb_path_2']], size=512, verbose=False)
            res1['rgb_mast3r_1'], res2['rgb_mast3r_2'] = rgb_mast3r[0], rgb_mast3r[1]

            res1['rgb_mast3r_1']['img'] = res1['rgb_mast3r_1']['img'].squeeze(0)
            res1['rgb_mast3r_1']['true_shape'] = res1['rgb_mast3r_1']['true_shape'].squeeze(0)

            res2['rgb_mast3r_2']['img'] = res2['rgb_mast3r_2']['img'].squeeze(0)
            res2['rgb_mast3r_2']['true_shape'] = res2['rgb_mast3r_2']['true_shape'].squeeze(0)
