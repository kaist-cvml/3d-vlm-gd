...
class ScanNetPPMASt3RDataset(Dataset):
    def __init__(self, 
                 root='data/scannetpp', 
    ...
    def __getitem__(self, idx):
        ...
        rgb_mast3r = load_images([str(img1_path), str(img2_path)], size=self.img_size, verbose=False)
        rgb_mast3r_1, rgb_mast3r_2 = rgb_mast3r[0], rgb_mast3r[1]

        rgb_mast3r_1['img'] = rgb_mast3r_1['img'].squeeze(0)
        rgb_mast3r_1['true_shape'] = rgb_mast3r_1['true_shape'].squeeze(0)

        rgb_mast3r_2['img'] = rgb_mast3r_2['img'].squeeze(0)
        rgb_mast3r_2['true_shape'] = rgb_mast3r_2['true_shape'].squeeze(0)
        ...
        return {
            ...
            'rgb_mast3r_1': rgb_mast3r_1,
            'rgb_mast3r_2': rgb_mast3r_2,
            'intrinsic': intrinsic,
        }
